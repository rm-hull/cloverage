...
(t/deftest test-wrap-primitives
  (t/is (expand= `(capture 0 1)       (inst/wrap #'cov/track-coverage 0 1)))
  (t/is (expand= `(capture 1 "foo")   (inst/wrap #'cov/track-coverage 0 "foo")))
  (t/is (expand= `(capture 2 ~'bar)   (inst/wrap #'cov/track-coverage 0 'bar)))
  (t/is (expand= `(capture 3 ~'true)  (inst/wrap #'cov/track-coverage 0 'true)))
  (t/is (expand= '(1 "foo" bar true)
                 (map :form @cov/*covered*))))

(t/deftest test-wrap-vector
  (t/is (expand= `(capture 0
                           [(capture 1 1)
                            (capture 2 "foo")
                            (capture 3 ~'bar)])
...
(t/deftest test-wrap-list
  (t/is (expand= `(capture 0 ((capture 1 +) (capture 2 1)
                              (capture 3 2)))
...
(t/deftest test-wrap-new
  (t/is (expand= `(capture 0 (~'new java.io.File (capture 1 "foo/bar")))
